...
| Saturation (ancien `moderate`, modèle fermé) | 56 809 req (947/s), 0 % d'échec, p95 117,6 ms, p99 180,9 ms (seuil p95 < 100 ms franchi ; k6 et le Core se partagent le CPU de la VM) |
