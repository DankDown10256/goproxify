...
func Templates() []Template {
	return []Template{
		...
		},
		{
			...
			Description: "Notifie dès qu'une passerelle ou un Agent n'a pas envoyé de heartbeat depuis plus de 5 minutes.",
			CooldownSec: 900,
		...
		},
		{
			...
			Description: "Déclenche un snapshot de sauvegarde quand une passerelle ou un Agent est sans heartbeat depuis plus de 30 minutes.",
			CooldownSec: 3600,
