...
// labelRoute fait suivre des labels Docker jusqu'à la route du Core (Agent → payload → Core).
...
// n'arrive pas à la route (clé JSON différente entre l'Agent et le Core) est un no-op silencieux.
