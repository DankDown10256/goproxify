...
// Le Core reprend la trace de l'appelant, la prolonge vers le backend et l'expose au client.
...
// Sans exporteur, un traceparent entrant reste transmis tel quel : le Core est transparent.
