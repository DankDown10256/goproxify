...
// Package geoip assure la disponibilité de la base MaxMind GeoLite2 sur la passerelle.
package geoip
...
// Bootstrap télécharge la base si absente, selon la config passerelle (geoip.*).
...
func download(dest, rawURL string) error {
	...
	req.Header.Set("User-Agent", "goproxify-edge/geoip")
