...
type Config struct {
	...
	AuthProviderID       string `json:"auth_provider_id"`       // optionnel — fournisseur passerelle
...
// SyncedUser est un compte poussé par l'Admin (métadonnées ; mot de passe reste sur passerelle).
