...
// Package errorpages génère les pages d'erreur HTML par défaut de la passerelle Goproxify.
...
// EdgeVersion est initialisé au démarrage (cmd/goproxify/main.go).
var EdgeVersion = "dev"
