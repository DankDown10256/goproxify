...
// Package raft implémente l'algorithme de consensus Raft utilisé par les passerelles
...
type Config struct {
	// ID unique du nœud (ex: "edge-1")
	ID string
	// Peers : map id → URL HTTP (ex: "edge-2" → "http://10.0.0.2:8002")
