...
// ValidateAdminHMAC valide la signature HMAC-SHA256 du handshake Admin→Passerelle.
...
// Pour simplifier la vérification côté passerelle, on compare directement les secrets stockés.
