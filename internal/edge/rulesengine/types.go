...
// en utilisant uniquement l'état en mémoire de la passerelle (sans DB).
...
const (
	CondCVECritical    ConditionType = "cve_critical"    // non évaluable en passerelle (toujours false)
